"""Unit tests of the Parent request form."""
from django import forms
from django.test import TestCase
from lessons.forms import ParentRequestForm
from lessons.models import Instrument,Request, Student
import datetime


class ParentRequestFormTestCase(TestCase):
    ...
    def test_parernt_request_form_has_necessary_fields(self):
        form = ParentRequestForm(user=self.user)
    ...
    def test_parent_form_uses_model_validation(self):
    ...
    def test_form_must_save_correctly(self):
        ...
        form = ParentRequestForm(instance=request, data=self.form_input, user=self.user)
