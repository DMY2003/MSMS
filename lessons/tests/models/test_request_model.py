...
def _create_second_request():
    fake = Faker("en_GB")

    instrument = Instrument.objects.create(name="test_intrument2")
    ...
    request = Request.objects.create(
        ...
        time_availability='13:00',
        day_availability=2,
        lesson_interval=1,
        lesson_count = 4,
        lesson_duration = 45,
        preferred_teacher = 'Jenny Doe',
        student=student,
        is_approved=False,
    )
    return request
...
class RequestModelTestCase(TestCase):
    ...
    def setUp(self):
        ...
        # instrument = Instrument.objects.create(name="test_intrument")
        ...
        #     instrument=instrument,
        #     time_availability='12:00',
        #     day_availability=1,
        #     lesson_interval=2,
        #     lesson_count = 3,
        #     lesson_duration = 60,
        #     preferred_teacher = 'Jane Doe',
        #     student=student,
        #     is_approved=False,
        # )
    ...
    #     second_request = _create_second_request()
