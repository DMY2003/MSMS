    ...
    operations = [
        ...
        name='Request',
            fields=[
                ...
                ('day_availability', models.IntegerField(choices=[(0, 'Monday'), (1, 'Tuesday'), (2, 'Wednesday'), (3, 'Thursday'), (4, 'Friday'), (5, 'Saturday'), (6, 'Sunday')])),
                ('lesson_interval', models.IntegerField(choices=[(1, '1 week'), (2, '2 weeks')])),
                ('lesson_count', models.IntegerField(validators=[django.core.validators.MinValueValidator(3), django.core.validators.MaxValueValidator(20)])),
                ('lesson_duration', models.IntegerField(choices=[(30, '30 minutes'), (45, '45 minutes'), (60, '60 minutes')])),
