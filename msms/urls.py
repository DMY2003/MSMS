...
urlpatterns = [
    ...
    path('administrator/approved_requests', views.admin_approved_requests, name='admin_requests'),
    path('administrator/unapproved_requests', views.admin_unapproved_requests, name='admin_requests'),
